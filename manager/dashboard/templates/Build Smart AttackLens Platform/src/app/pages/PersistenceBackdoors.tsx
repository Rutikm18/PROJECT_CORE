  ...
  return (
    <div className="space-y-2">
      ...
      <GenericDetectionPage
        ...
        subtitle={validatedOnly ? "Auto-promoted by Detection Confidence" : "LaunchDaemons · cron/launchd tasks · shell config injection · SUID binaries · world-writable PATH"}
        apiUrl={validatedOnly ? "/api/v1/detection/persistence?validated_only=true" : "/api/v1/detection/persistence"}
        accent="amber"
        icon={<Anchor className="w-5 h-5 text-orange-500" />}
        emptyMsg={validatedOnly ? "No validated findings in Persistence." : "No persistence findings yet. Agent needs to report services, tasks, configs, and binaries sections."}
        columns={[
