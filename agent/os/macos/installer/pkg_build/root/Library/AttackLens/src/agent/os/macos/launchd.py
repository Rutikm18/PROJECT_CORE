...
Provides:
  • AttackLensLaunchd — context manager that registers/unregisters the agent
...
LaunchDaemon hierarchy:
  launchd (KeepAlive = true) → attacklens-watchdog → attacklens-agent
...
_AGENT_LABEL    = "com.attacklens.agent"
_WATCHDOG_LABEL = "com.attacklens.watchdog"
...
_INSTALL_DIR    = "/Library/AttackLens/bin"
_AGENT_BIN      = f"{_INSTALL_DIR}/attacklens-agent"
_WATCHDOG_BIN   = f"{_INSTALL_DIR}/attacklens-watchdog"
_CONFIG_DEFAULT = "/Library/AttackLens/agent.toml"
_LOG_DIR        = "/Library/AttackLens/logs"
...
<dict>
    ...
    <string>/Library/AttackLens</string>
...
def agent_main(config_path: str | None = None) -> None:
    ...
    sys.argv = ["attacklens-agent", "--config", args.config]
