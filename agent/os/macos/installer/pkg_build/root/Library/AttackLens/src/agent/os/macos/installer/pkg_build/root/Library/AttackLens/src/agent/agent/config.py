...
class WatchdogConfig:
    """Settings for the process watchdog (attacklens-watchdog binary)."""
    enabled:            bool = True
...
class PathsConfig:
    ...
    Layout (set by agent/os/macos/installer/install.sh):
      /Library/AttackLens/
        bin/                         — attacklens-agent, attacklens-watchdog binaries
      /Library/AttackLens/
      ...
      /Library/AttackLens/logs/    — rotating log files
      /Library/AttackLens/attacklens-agent.pid    — PID file
    """
    install_dir:  str = "/Library/AttackLens"
    config_dir:   str = "/Library/AttackLens"
    log_dir:      str = "/Library/AttackLens/logs"
    data_dir:     str = "/Library/AttackLens/data"
    security_dir: str = "/Library/AttackLens/security"
    spool_dir:    str = "/Library/AttackLens/spool"
    pid_file:     str = "/Library/AttackLens/attacklens-agent.pid"


@dataclass
class BinariesConfig:
    """Paths to compiled binaries managed by the watchdog."""
    agent:    str = "/Library/AttackLens/bin/attacklens-agent"
    watchdog: str = "/Library/AttackLens/bin/attacklens-watchdog"
...
class LoggingConfig:
    level:   str = "INFO"
    file:    str = "/Library/AttackLens/logs/agent.log"
    max_mb:  int = 10
    backups: int = 3
